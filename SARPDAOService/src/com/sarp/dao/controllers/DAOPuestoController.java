...
public class DAOPuestoController {
	...
	public void crearPuesto(BusinessPuesto p){
		...
		puestoRepository.insertPuesto(p.getNombreMaquina(),p.getUsuarioId(),p.getEstado().toString(),p.getNumero());
	...
	public void modificarPuesto(BusinessPuesto puesto) throws Exception {
		...
		em.getTransaction().begin();
		puestoRepository.updatePuesto(puesto.getNombreMaquina(), puesto.getEstado().toString(), puesto.getUsuarioId(),puesto.getNumero());
		em.getTransaction().commit();
		em.close();
	}
	...
	public void desasociarNumeroPuestoActual(String nombreMaquina, int codigoNumero) throws Exception{
		EntityManager em = EMFactory.getEntityManager();
		DAONumero numeroRepository = factory.getNumeroRepository(em);
		DAOPuesto puestoRepository = factory.getPuestoRepository(em);
