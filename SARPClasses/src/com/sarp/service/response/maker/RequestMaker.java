...
public class RequestMaker {
	...
	public BusinessNumero requestNumero(JSONNumero numero) throws Exception {
		...
		try{
			...
			return numero != null ? new BusinessNumero(numero.getId(),numero.getExternalId(),horaNumero,numero.getEstado(),numero.getPrioridad(),numero.getIdTramite(),numero.getIdSector(), false) : null;
		}catch(Exception e){
	...
	public BusinessNumero requestNumeroFromNumPuesto(JSONNumeroPuesto numPuesto){
		...
		if(numPuesto != null){
			BusinessNumero numero =  new BusinessNumero(numPuesto.getNumeroId(), null, null, null, null, null, null,false);
			return numero;
		}else{
			return null;
		}
